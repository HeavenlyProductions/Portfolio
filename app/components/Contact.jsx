...
const Contact = () => {
    ...
    const onSubmit = async (event) => {
        ...
        formData.append("access_key", "46d40343-88c2-4846-bd37-7da52b68f2e7");
            ...
            <motion.form
                ...
                <div className='grid auto gap-6 mt-10 mb-8'>
                    ...
                    <motion.input
                        ...
                        rounded-md bg-white ${theme === 'dark' ? 'darkBg border-white/90' : ''}`}
                        name='name' />
                ...
                <motion.textarea
                    ...
                    ${theme === 'dark' ? 'darkBg border-white/90' : ''}`} name='message'>
                </motion.textarea>
